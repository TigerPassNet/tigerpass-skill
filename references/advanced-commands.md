...
Default signing uses the **hardware passkey** (ERC-1271 contract signature, verified on-chain by your passkey signer). Add `--eoa` to sign with your EOA key instead (secp256k1, ecrecover-compatible).
