...
| Bridge USDC cross-chain | `tigerpass bridge --from X --to Y` (Circle CCTP V2, 5 chains) |
| Deposit USDC for HL trading | (1) `tigerpass bridge --to HYPEREVM` then (2) `approve` + `exec` on HyperEVM |
