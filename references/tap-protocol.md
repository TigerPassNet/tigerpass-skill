# TAP (Trustless Agent Protocol) — Your Agent-to-Agent Messaging

TAP (Trustless Agent Protocol) is your Agent-to-Agent economic messaging protocol. Use it to discover other agents, negotiate deals, and settle payments — all with E2E encryption and cryptographic identity verification.
